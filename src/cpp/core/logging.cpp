...
{
    void setup_app_logs() {
        static plog::RollingFileAppender<plog::CsvFormatter> fileAppender(Global::asset_manager->getDataPath("app-log.csv").string().c_str(), 24000, 1); // Create the 1st appender.
